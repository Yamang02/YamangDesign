...
> = {
  badge: [
    ...
    { token: '--ds-color-text-on-action-primary', label: 'primary 텍스트' },
    { token: '--ds-color-action-secondary-default', label: 'secondary 배경' },
    { token: '--ds-color-text-on-action-secondary', label: 'secondary 텍스트' },
    { token: '--ds-color-action-accent-default', label: 'accent 배경' },
    { token: '--ds-color-text-on-action-accent', label: 'accent 텍스트' },
  ...
  avatar: [
    ...
    { token: '--ds-color-text-on-action-primary', label: '이니셜 텍스트' },
    { token: '--ds-color-action-primary-default', label: 'primary 배경' },
    { token: '--ds-color-action-secondary-default', label: 'secondary 배경' },
    { token: '--ds-color-action-accent-default', label: 'accent 배경' },
  ],
  button: [
    ...
    { token: '--ds-color-text-on-action-primary', label: '버튼 텍스트 (primary)' },
    { token: '--ds-color-action-secondary-default', label: 'secondary 기본' },
    { token: '--ds-color-action-secondary-hover', label: 'secondary hover' },
    { token: '--ds-color-action-secondary-active', label: 'secondary active' },
    { token: '--ds-color-text-on-action-secondary', label: '버튼 텍스트 (secondary)' },
    { token: '--ds-color-action-accent-default', label: 'accent 기본' },
    { token: '--ds-color-action-accent-hover', label: 'accent hover' },
    { token: '--ds-color-action-accent-active', label: 'accent active' },
    { token: '--ds-color-text-on-action-accent', label: '버튼 텍스트 (accent)' },
  ...
  select: [
    ...
    { token: '--ds-color-action-primary-default', label: '선택 옵션 배경' },
    { token: '--ds-color-text-on-action-primary', label: '선택 옵션 텍스트' },
    { token: '--ds-color-border-focus', label: '포커스' },
