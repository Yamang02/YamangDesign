...
- **테스트**가 P07에서 식별된 우선 영역(`app/components`, 주요 labs·페이지)에 대해 smoke/상호작용 수준으로 보강된다.
...
- **대형 훅 분리·CC-05 엄격 적용**은 별도 태스크로 쪼갤 수 있으며, 본 에픽 기본 범위에 필수로 넣지 않는다(백로그 후보 — 인라인 주석·CC-05는 백로그 E28-B0001).
...
- 승격 원본: E27-B0001 (`status: selected`).
