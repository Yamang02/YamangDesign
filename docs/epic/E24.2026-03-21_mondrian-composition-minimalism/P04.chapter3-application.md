...
- [ ] `ArtApplicationSection` Ch.3 섹션 렌더 확인 (Color Tokens / Buttons / Typography / Art Card 4블록)
- [ ] `id="chapter-3"` 앵커 설정
- [ ] WCAG: 버튼 텍스트-배경 대비 4.5:1 이상 확인 (Primary `#7A9BBF`/`#F5F2EC`)
- [ ] ArtShell 챕터 네비게이션 — Ch.1/2/3 전환 정상 동작
- [ ] 모바일(375px) 전체 레이아웃 확인
- [ ] `npx tsc --noEmit` 에러 없음
- [ ] 커밋: `feat(E24): MondriComposition — Mondrian Minimalism 아트 페이지 완성`
