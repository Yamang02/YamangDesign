...
- 브랜치: `epic/E32-admin-shell-reference` 권장. Phase 작업은 `feat/E32/P##-…` 형태로 추적한다 (GC-01).
...
## 후속 Phase (예정)
다음은 P01 산출과 구현 속도에 따라 쪼개거나 합칠 수 있다.
- 토큰·기초 스타일 정렬, 기존 app atoms 확장
- Admin 레이아웃 셸(사이드바·헤더·콘텐츠)
- 복합 블록(표 툴바·필터 등) 및 Lab·데모 진입점
